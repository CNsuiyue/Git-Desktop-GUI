...
window.gitAPI = {
  ...
  getProjectConfig: () => invoke('git_get_local_config'),
  setGlobalConfig: (key, value) => invoke('git_set_global_config', { key, value }),
  setProjectConfig: (key, value) => invoke('git_set_local_config', { key, value }),
  addRemote: (name, url) => invoke('git_add_remote', { name, url }),
