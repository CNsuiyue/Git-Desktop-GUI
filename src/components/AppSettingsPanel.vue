      ...
      <div class="settings-layout">
        ...
        <div class="settings-sidebar">
          <div class="about-section">
            ...
            <button class="about-link" @click="openRepoLink">
            ...
            <span class="about-license">本项目使用 MIT 协议进行开源 请遵守协议内容 </span>
          </div>
        </div>
      </div>
    </div>
...
async function openRepoLink() {
  await window.gitAPI.openUrl('https://github.com/CNsuiyue/Git-Desktop-GUI')
}
